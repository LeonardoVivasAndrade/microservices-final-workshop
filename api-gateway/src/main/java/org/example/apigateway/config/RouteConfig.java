...
public class RouteConfig {
    ...
    public RouteLocator createRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route(transactionsServiceId, route -> route.path(transactionsServicePath).filters(gtf -> gtf.filter(filter)).uri(transactionsServiceUrl))
